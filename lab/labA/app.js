...
function displayPics(){
  ...
  // 'I believe that let threw an error code because makeRandom() is an already defined function. Unlike using var, let will now let you redefine a variable or function that has already been defined.'
  console.log(viewed);
